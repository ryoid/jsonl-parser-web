...
const arrayObjectMixData = [[1, 'Hello'], { id: 2, message: 'Hello' }, [3, 'Hello']]
type ArrayObjectMixData = (typeof arrayObjectMixData)[number]

const dataDir = `${__dirname}/testdata`

function readTestDataAsReadableStream(name: string) {
  ...
  return webReadableStream as ReadableStream<Uint8Array>
}
